...
Feature: Search 2
  ...
  @CU-32447
  Scenario Outline: [VLCC] Pre-search filters popup UI verification from Content Box Link
    * I am logged in
  ...
  @CU-32448
  Scenario Outline: [VLCC] Pre-search filters popup UI verification from Content Box See All
    * I am logged in
    * I am on "<Practice Area>" PA
